...
public class ApiClient {
    ...
    private String basePath = "https://api.xpay.lucfish.com/v1";
    ...
    private void init() {
        ...
        setUserAgent("XPay/v1 JavaBindings/v1");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.xpay.lucfish.com/v1
